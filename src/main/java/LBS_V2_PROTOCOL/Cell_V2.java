...
public final class Cell_V2 extends JceStruct {
    ...
    public void display(StringBuilder sb5, int i15) {
        JceDisplayer jceDisplayer = new JceDisplayer(sb5, i15);
    ...
    public Cell_V2(short s15, short s16, int i15, int i16, int i17, double d3, double d15) {
        this.shMcc = s15;
        this.shMnc = s16;
        this.iLac = i15;
        this.iCellId = i16;
