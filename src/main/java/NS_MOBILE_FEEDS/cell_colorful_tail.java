...
public final class cell_colorful_tail extends JceStruct {
    ...
    public cell_colorful_tail(String str, String str2, String str3, s_tail_color s_tail_colorVar, s_tail_color s_tail_colorVar2, int i15, Map<String, String> map, String str4) {
        this.action_url = str;
        this.name = str2;
        this.desc = str3;
