...
public final class cell_comment extends JceStruct {
    ...
    public cell_comment(int i15, ArrayList<s_commment> arrayList, s_commment s_commmentVar, int i16, int i17, int i18, int i19, s_plug_in_comment s_plug_in_commentVar, String str, int i25) {
        this.num = i15;
        ...
        this.txt = str;
        this.comment_and_reply_num = i25;
    }
}