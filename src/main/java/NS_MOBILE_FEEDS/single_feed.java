...
public final class single_feed extends JceStruct {
    ...
    public single_feed(Map<Integer, byte[]> map, long j15, String str, String str2, String str3, int i15, ArrayList<Map<Integer, byte[]>> arrayList, long j16, Map<Integer, byte[]> map2, long j17, boolean z15, int i16) {
        this.singlefeed = map;
        this.status = j15;
        this.feed_info = str;
