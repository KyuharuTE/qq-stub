...
public final class s_button extends JceStruct {
    ...
    public s_button(String str, int i15, String str2, String str3, String str4, String str5, Map<Integer, Integer> map, int i16, int i17, String str6, int i18, Map<String, String> map2) {
        this.text = str;
        this.actiontype = i15;
        this.actionurl = str2;
