...
public final class cell_operation extends JceStruct {
    ...
    static {
        ...
        map.put("", "");
        cache_click_stream_report.put(0, map);
    ...
    public cell_operation(Map<Integer, String> map, String str, String str2, s_outshare s_outshareVar, s_schema s_schemaVar, Map<Integer, String> map2, Map<Integer, Map<String, String>> map3, String str3, ArrayList<s_op_btn> arrayList, Map<Integer, String> map4, String str4, Map<String, String> map5, Map<Integer, String> map6, Map<Integer, String> map7, String str5, long j15, String str6) {
        this.busi_param = map;
        this.weixin_url = str;
        this.qq_url = str2;
