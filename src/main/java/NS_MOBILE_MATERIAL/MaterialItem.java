...
public final class MaterialItem extends JceStruct {
    ...
    static {
        ...
        cache_strExtFields = new byte[]{0};
        HashMap map = new HashMap();
        cache_mapExtInfo = map;
        map.put("", "");
    ...
    public MaterialItem(int i15, int i16, int i17, String str, int i18, ArrayList<MaterialFile> arrayList, String str2, String str3, MaterialFile materialFile, MaterialFile materialFile2, long j15, String str4, String str5, byte[] bArr, Map<String, String> map, MaterialFile materialFile3, MaterialFile materialFile4) {
        this.iItemId = i15;
        this.iTypeId = i16;
        this.iItemType = i17;
