...
public class LbsDataV2 {
    ...
    public static class GeoInfo implements Parcelable {
        public static final Parcelable.Creator<GeoInfo> CREATOR = new Parcelable.Creator<GeoInfo>() { // from class: cooperation.qzone.LbsDataV2.GeoInfo.1
            ...
            public GeoInfo[] newArray(int i15) {
                return null;
            }
        ...
        public void writeToParcel(Parcel parcel, int i15) {
            ...
            parcel.writeParcelable(this.gpsInfo, i15);
        }

        /* renamed from: clone, reason: merged with bridge method [inline-methods] */
        public GeoInfo m484clone() {
            GeoInfo geoInfo = new GeoInfo();
            ...
            if (gpsInfo != null) {
                geoInfo.gpsInfo = gpsInfo.m485clone();
            }
            return geoInfo;
        }

        public GeoInfo(int i15, int i16, String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8) {
            this.iDistrictCode = i15;
            this.iRange = i16;
            this.strCountry = str;
    ...
    public static class GpsInfo implements Parcelable {
        public static final Parcelable.Creator<GpsInfo> CREATOR = new Parcelable.Creator<GpsInfo>() { // from class: cooperation.qzone.LbsDataV2.GpsInfo.1
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // android.os.Parcelable.Creator
            public GpsInfo[] newArray(int i15) {
                return null;
            }
        ...
        public GpsInfo() {
            int i15 = LbsDataV2.GPS_DEFAULT_VALUE;
            this.lat = i15;
            this.lon = i15;
            this.alt = -10000000;
            this.gpsType = 0;
        ...
        public boolean isValid() {
            ...
            return (i15 == i16 || this.lon == i16) ? false : true;
        }
        ...
        /* renamed from: clone, reason: merged with bridge method [inline-methods] */
        public GpsInfo m485clone() {
            return new GpsInfo(this.lat, this.lon, this.alt, this.gpsType, this.accuracy);
        }

        public GpsInfo(int i15, int i16, int i17, int i18, int i19) {
            int i25 = LbsDataV2.GPS_DEFAULT_VALUE;
            this.lat = i15;
            this.lon = i16;
            this.alt = i17;
            this.gpsType = i18;
    ...
    public static class PoiInfo implements Parcelable {
        public static final Parcelable.Creator<PoiInfo> CREATOR = new Parcelable.Creator<PoiInfo>() { // from class: cooperation.qzone.LbsDataV2.PoiInfo.1
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // android.os.Parcelable.Creator
            public PoiInfo[] newArray(int i15) {
                return null;
            }
        ...
        public static PoiInfo clone(PoiInfo poiInfo) {
            ...
            poiInfo2.gpsInfo = gpsInfo != null ? gpsInfo.m485clone() : null;
    ...
    public static GpsInfo convertFromSoso(SosoLocation sosoLocation) {
        ...
        double d3 = sosoLocation.mLon84;
        if (d3 == 0.0d && sosoLocation.mLat84 == 0.0d) {
            gpsInfo.gpsType = 1;
    ...
    public static ArrayList<PoiInfo> fromSosoLocation(SosoLocation sosoLocation) {
        ...
        if (sosoLocation != null && (list = sosoLocation.poi) != null && !list.isEmpty()) {
            for (int i15 = 0; i15 < sosoLocation.poi.size(); i15++) {
                PoiInfo poiInfoFromTencentPoi = fromTencentPoi(sosoLocation.poi.get(i15));
                poiInfoFromTencentPoi.country = sosoLocation.nation;
                poiInfoFromTencentPoi.province = sosoLocation.province;
                poiInfoFromTencentPoi.city = sosoLocation.city;
                poiInfoFromTencentPoi.district = sosoLocation.district;
                arrayList.add(poiInfoFromTencentPoi);
            }
        }
        return arrayList;
    }
    ...
    public static class GetGeoInfoRsp implements Parcelable {
        public static final Parcelable.Creator<GetGeoInfoRsp> CREATOR = new Parcelable.Creator<GetGeoInfoRsp>() { // from class: cooperation.qzone.LbsDataV2.GetGeoInfoRsp.1
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // android.os.Parcelable.Creator
            public GetGeoInfoRsp[] newArray(int i15) {
                return null;
            }
        ...
        @Override // android.os.Parcelable
        public void writeToParcel(Parcel parcel, int i15) {
            parcel.writeParcelable(this.stGps, i15);
            parcel.writeParcelable(this.stGeoInfo, i15);
        }
    ...
    public static class WifiInfo implements Parcelable {
        public static final Parcelable.Creator<WifiInfo> CREATOR = new Parcelable.Creator<WifiInfo>() { // from class: cooperation.qzone.LbsDataV2.WifiInfo.1
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // android.os.Parcelable.Creator
            public WifiInfo[] newArray(int i15) {
                return null;
            }
        ...
        public WifiInfo(String str, int i15) {
            this.mac = str;
            this.rssi = i15;
        }
    }
    ...
    public static class CellInfo implements Parcelable {
        public static final Parcelable.Creator<CellInfo> CREATOR = new Parcelable.Creator<CellInfo>() { // from class: cooperation.qzone.LbsDataV2.CellInfo.1
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // android.os.Parcelable.Creator
            public CellInfo[] newArray(int i15) {
                return null;
            }
        ...
        public CellInfo(int i15, int i16, int i17, int i18, int i19, double d3, double d15) {
            this.mcc = i15;
            this.mnc = i16;
            this.lac = i17;
            this.cellId = i18;
