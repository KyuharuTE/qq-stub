...
public final class s_outshare extends JceStruct {
    ...
    public s_outshare(String str, String str2, String str3, String str4, Map<Integer, s_picurl> map, int i15, int i16, String str5, String str6, String str7, String str8, int i17, s_arkshare s_arkshareVar) {
        this.weixin_url = str;
        this.qq_url = str2;
        this.title = str3;
        this.summary = str4;
        this.photourl = map;
        this.space_right = i15;
